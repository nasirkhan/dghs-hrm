 ...
 */
if ($_REQUEST['show_old_menu'] == 'true') {
  $show_sanctioned_post_child_menu = FALSE;
  if ($active_menu == "sanctioned_post" || $active_menu == "sanctioned_post_sorted" || $active_menu == "sanctioned_post2" || $active_menu == "sanctioned_post_add" || $active_menu == "sanctioned_post_repot") {
  ...
  if ($active_menu == "employee" || $active_menu == "employee_add" || $active_menu == "move_staff" || $active_menu == "match_employee" || $active_menu == "employee_report") {
...
if (hasPermission('mod_admin', 'view_report_menu', getLoggedUserName())) {
  echo "<a href=\"report_index.php\"><i class=\"icon-list\"></i> Reports</a>";
}
?>