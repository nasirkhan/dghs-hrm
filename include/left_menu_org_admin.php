...
<ul id="leftMenuAdmin">
    ...
    <ul>
        ...
        <li><a href="employee.php.php?org_code=<?= $org_code?>">Employee</a></li>
        <ul>
            <li><a href="employee.php.php?org_code=<?= $org_code?>">Search</a></li>
            <li><a href="employee.php.php?org_code=<?= $org_code?>">Add</a></li>
            <li><a href="update_sanctioned_post.php?org_code=<?= $org_code?>">Add</a></li>
