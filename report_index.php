                ...
                <div class="span9">
                    ...
                    <section id="report">
                        ...
                        <div class="row-fluid">
                            ...
                            <ul>
                                <li>
                                    <a href="report_master.php?t=post&f_division_code=1&division_code=30&f_district_code=1&district_code=26&admin_upazila=1&upazila_id=2&noDatatable=true&f_org_type_code=1&f_designation=1&SQLSelect=p.pay_scale!=0&SQLGroup=class,pay_scale,type_of_post_name,designation&ColOrder=designation,type_of_post_name,class,pay_scale&ColAlias=Designation,Type of Post,Class,Payscale&orderbyfull=pay_scale,designation_ranking&rTitle=Designation Wise Report&submit=">Designation Wise Summary Report </a>
                                </li>
                                <li>
