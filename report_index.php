                    ...
                    <section id="report">
                        ...
                        <div class="row-fluid">
                            ...
                            <!--    <li>
                                ...
                                <li>
                                    <a href="report_master.php?t=&f_division_code=1&division_code=&f_district_code=1&district_code=&admin_upazila=1&upazila_id=&noDatatable=true&f_bangladesh_professional_category_code=1&f_designation=1&f_type_of_code=1&SQLSelect=p.active+%3D+1&SQLGroup=type_of_post%2Cclass%2Cpay_scale%2Cdesignation&ColOrder=designation%2Ctype_of_post_name%2Cclass%2Cpay_scale%2Corg_name&ColAlias=Designation%2CType+of+Post%2CClass%2CPay+Scale%2CInstitute+Name&orderbyfull=pay_scale%2Cdesignation_ranking&rTitle=Type+of+post+and+Institute+wise+designation&submit=">Type of post and Institute wise designation</a></li>
                                
                                
                                <li>
                                    <a href="report_master.php?t=post&f_division_code=1&division_code=&f_district_code=1&district_code=&admin_upazila=1&upazila_id=&noDatatable=true&f_staff_professional_category=1&f_professional_discipline_of_current_designation=1&f_group_code=1&group_code[]=100042&SQLSelect=p.active+%3D+1+AND+p.designation_group_name!%3D%27%27+AND+o.org_name!%3D%27%27&SQLGroup=pay_scale%2Co.org_code&ColOrder=designation_group_name%2Cclass%2Cpay_scale%2Corg_name&ColAlias=Designation+Group%2CClass%2CPay+Scale%2CInstitute+Name&orderbyfull=o.org_name&rTitle=Institute+Wise+Designation+Group&submit=">Institute Wise Designation Group</a>
                                </li>
				<li>
                                    <a href="report_master.php?t=post&f_division_code=1&division_code=&f_district_code=1&district_code=&admin_upazila=1&upazila_id=&noDatatable=true&f_bangladesh_professional_category_code=1&f_org_type_code=1&SQLSelect=p.active+%3D+1&SQLGroup=p.org_name&ColOrder=org_name&ColAlias=Institute+Name&orderbyfull=&rTitle=Institute+Wise+Summary+Report&submit=">Institute Wise Summary Report</a>
                                </li>
                            </ul>
                            Personnel wise report
                            <ul>
                                <li>
                                    <a href="report_master.php?t=&f_division_code=1&division_code=&f_district_code=1&district_code=&admin_upazila=1&upazila_id=&noDatatable=true&f_org_type_code=1&f_professional_discipline_of_current_designation=1&f_group_code=1&SQLSelect=p.pay_scale!%3D0+AND+p.active+%3D+1+AND+s.staff_name!%3D+%27%27&SQLGroup=&ColOrder=designation_group_name%2Cprofessional_discipline_of_current_designation_name%2Cstaff_id%2Cstaff_pds_code%2Cstaff_name%2Cbirth_date%2Cjob_posting_name%2Corg_name%2Ccontact_no&ColAlias=Designation+Group+Name%2CDiscipline%2CStaff+ID%2CPDS+Code+No.%2CName%2CDate+of+Birth%2CPosting+Status%2CPlace+of+Posting%2CMobile+No&orderbyfull=pay_scale%2Cdesignation_ranking&rTitle=Discipline+wise+report+with+Designation+group&submit=">Discipline wise report with Designation group</a>
                                </li>
                                <li>
                                    <a href="report_master.php?t=&f_division_code=1&division_code=&f_district_code=1&district_code=&admin_upazila=1&upazila_id=&noDatatable=true&f_org_type_code=1&f_professional_discipline_of_current_designation=1&f_group_code=1&SQLSelect=p.pay_scale!%3D0+AND+p.active+%3D+1+AND+s.staff_name!%3D+%27%27&SQLGroup=&ColOrder=professional_discipline_of_current_designation_name%2Cdesignation_group_name%2Cstaff_id%2Cstaff_pds_code%2Cstaff_name%2Cbirth_date%2Cjob_posting_name%2Corg_name%2Ccontact_no&ColAlias=Discipline%2CDesignation+Group+Name%2CEmployee+No%2CPDS+Code+No.%2CName%2CDate+of+Birth%2CPosting+Status%2CPlace+of+Posting%2CMobile+No&orderbyfull=pay_scale%2Cdesignation_ranking&rTitle=Designation+group+wise+report+with+discipline&submit=">Designation group wise report with discipline</a>
                                </li>
                                <li>
                                    <a href="report_master.php?t=&f_division_code=1&division_code=&f_district_code=1&district_code=&admin_upazila=1&upazila_id=&org_code[]=&noDatatable=true&f_designation=1&SQLSelect=p.pay_scale!%3D0+AND+p.active+%3D+1+AND+s.staff_name!%3D+%27%27&SQLGroup=&ColOrder=designation%2Cstaff_id%2Cstaff_pds_code%2Cstaff_name%2Cbirth_date%2Cjob_posting_name%2Corg_name%2Ccontact_no&ColAlias=Designation%2CEmployee+No%2CPDS+Code+No.%2CName%2CDate+of+Birth%2CPosting+Status%2CPlace+of+Posting%2CMobile+No&orderbyfull=pay_scale%2Cdesignation_ranking&rTitle=Designation+wise+report+&submit=">Designation wise report </a>
                                </li>
                                <li>
