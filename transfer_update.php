...
if (isset($_REQUEST['order_type'])) {
    ...
    if ($order_type == "order") {
        ...
        $sql = "UPDATE `transfer_queue` SET `memo_no`='$transfer_memo_no', `memo_date`='$transfer_memo_date', `comment`='$transfer_comment' WHERE order_creater_by LIKE \"$user_name\" and `status` LIKE \"pending\" ORDER BY `serial`";
...
//        print_r($sql);
        ...
        header("location:transfer_staff.php?org_code=$org_code");
                    ...
                    <section id="search_main">
                        ...
                        if ($_REQUEST['order_type'] == "order"):
                            ...
                            <div class="hidden-print">
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                                    ...
                                    <input type="hidden" name="order_memo_no" value="<?php echo mysql_real_escape_string(trim($_POST['order_memo_no']));; ?>" />
                                    <input type="hidden" name="order_memo_date" value="<?php echo mysql_real_escape_string(trim($_POST['order_memo_date']));; ?>" />
                        ...
                        <?php elseif ($_REQUEST['order_type'] == "release"):
                            ...
                            <div class="hidden-print">
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                                    <input type="hidden" name="transfer_id" value="<?php echo $data['id']; ?>" />
                                    <input type="hidden" name="order_type" value="release_submit" />
