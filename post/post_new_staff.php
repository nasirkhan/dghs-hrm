...
//    die();
  ...
  $staff_bangla_name = mysql_real_escape_string(trim($_POST['staff_bangla_name']));
  ...
  $ist_year = mysql_real_escape_string(trim($_POST['ist_year']));
  $ist_appoinment_date = mysql_real_escape_string(trim($_POST['ist_appoinment_date']));
  $ist_go = mysql_real_escape_string(trim($_POST['ist_go']));
  $ist_sl_no = mysql_real_escape_string(trim($_POST['ist_sl_no']));
  $bcs_batch_no = mysql_real_escape_string(trim($_POST['bcs_batch_no']));
  $bcs_psc_regularization_date = mysql_real_escape_string(trim($_POST['bcs_psc_regularization_date']));
  $bcs_psc_regularization_go = mysql_real_escape_string(trim($_POST['bcs_psc_regularization_go']));
  $bcs_psc_regularization_sl_no = mysql_real_escape_string(trim($_POST['bcs_psc_regularization_sl_no']));
  $service_confirmation_date = mysql_real_escape_string(trim($_POST['service_confirmation_date']));
  $service_confirmation_go = mysql_real_escape_string(trim($_POST['service_confirmation_go']));
  $service_confirmation_sl_no = mysql_real_escape_string(trim($_POST['service_confirmation_sl_no']));
  ...
  $sql = "INSERT INTO `old_tbl_staff_organization` (
                ...
                `ist_sl_no`,
                `bcs_batch_no`,
                `bcs_psc_regularization_date`,
                `bcs_psc_regularization_go`,
                `bcs_psc_regularization_sl_no`,
                `service_confirmation_date`,
                `service_confirmation_go`,
                `service_confirmation_sl_no`,
 ...
 * *******************************
 */
$url = "http://app.dghs.gov.bd/hrm/match_employee.php?org_code=$org_code";
redirect($url);
