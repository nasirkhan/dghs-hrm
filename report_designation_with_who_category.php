...
if ($who_professional > 0) {
    $query_string .= " AND  total_manpower_imported_sanctioned_post_copy.who_occupation_group_code = $who_professional";
}


if ($error_message == "" && isset($_REQUEST['form_submit'])) {
    $sql = "SELECT
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
                                        <h3>Designation Summary Report with WHO Professional Category</h3>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <a href="report_designation_with_who_category.php" class="btn btn-default" > Reset</a>
