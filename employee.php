...
<body data-spy="scroll" data-target=".bs-docs-sidebar">
	...
	<div class="container">
		...
		<div class="row">
				...
				<section id="organization-profile">
					...
					<div class="row">
						<div class="span9">
								...
								<div>
									If you want to view a specific staff profile, please use the
									following serchbox to find. <br /> Or, you can find the staff
									form the <a href="sanctioned_post.php">Sanctioned Post Page</a>.
								</div>
								<div>
									<form class="form-signin"
										...
										<div class="input-append">
											...
											<input class="span4" id="search" name="search" type="text"
                                ...
                                <?php if ($display_mode == "view"): ?>
                                    <table
								class="table table-striped table-hover" id="employee-profile">
								<tr>
								...
								<tr>
									<td width="50%"><strong>Fathers Name</strong></td>
									<!--father_name -->
								...
								<tr>
									<td width="50%"><strong>Professional Discipline of Current
							 ...
							 ?>
								...
								<tr>
									<td width="50%"><strong>Staff Name</strong></td>
									<td><a href="#" class="staff_name" data-type="text"
										id="staff_name"><?php echo $data['staff_name']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Organization Name</strong></td>
									<td><?php echo getOrgNameFormOrgCode($data['org_code']); ?></td>
								...
								<tr>
									<td width="50%"><strong><a href="#">Code No.(Doctors Only):</a></strong></td>
									<td><a href="#" class="text-input" data-type="text"
										id="staff_pds_code"><?php echo $data['staff_pds_code']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Department</strong></td>
								...
								<tr>
									...
									<!--father_name -->
									<td><a href="#" class="text-input" data-type="text"
										id="father_name"><?php echo $data['father_name']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Mothers Name</strong></td>
									<td><a href="#" class="text-input" data-type="text"
										id="mother_name"><?php echo $data['mother_name']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Email Address</strong></td>
									<td><a href="#" class="text-input" data-type="email"
										id="email_address"><?php echo $data['email_address']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Contact No.</strong></td>
									<td><a href="#" class="contact_no" id="contact_no"><?php echo $data['contact_no']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Present Address</strong></td>
									<!-- mailing_address  -->
								...
								<tr>
									<td width="50%"><strong>Pay Scale of Current Designation</strong></td>
									<td><a href="#" id="pay_scale_of_current_designation"
										name="pay_scale_of_current_designation"><?php echo getPayScaleId($data['pay_scale_of_current_designation']); ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Current Basic Pay (Tk.):</strong></td>
									<td><a href="#" class="text-input" data-type="text"
										id="current_basic_pay_taka" name="current_basic_pay_taka"><?php echo $data['current_basic_pay_taka']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Date Of Joining to Govt. Health Service</strong></td>
									<td><a href="#" class="date-input"
										id="date_of_joining_to_govt_health_service"><?php echo $data['date_of_joining_to_govt_health_service']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Date Of Joining to Current Place</strong></td>
									<td><a href="#" class="date-input"
										id="date_of_joining_to_current_place"><?php echo $data['date_of_joining_to_current_place']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Date Of Joining to Current Designation</strong></td>
									<td><a href="#" class="date-input"
										id="date_of_joining_to_current_designation"><?php echo $data['date_of_joining_to_current_designation']; ?></a></td>
								...
								<tr>
									<td width="50%"><strong>Professional Discipline of Current
											Designation</strong></td>
									<td><a href="#"
										id="professional_discipline_of_current_designation"
										name="professional_discipline_of_current_designation"><?php echo getProfessionalDisciplineNameFromId($data['professional_discipline_of_current_designation']); ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Education Qualification</strong></td>
									<!--type_of_educational_qualification-->
								...
								<tr>
									<td width="50%"><strong>Actual Degree</strong></td>
									<td><a href="#" class="text-input" data-type="text"
										id="actual_degree" name="actual_degree"><?php echo $data['actual_degree']; ?></a></td>
								</tr>
								<!--
                                        <tr>
                                            <td width="50%"><strong>Designation Id</strong></td>
								...
								<tr>
									<td width="50%"><strong>Further Remarks/Explanation:</strong></td>
									<!--reason -->
									<td><a href="#" class="text-input" data-type="text" id="reason"
										name="reason"><?php echo $data['reason']; ?></a></td>
								</tr>
								<tr>
									<td width="50%"><strong>Last Updated On</strong></td>
									<td><?php echo $data['last_update']; ?></td>
																																...
																																<?php																																// add new employee
																																elseif ($display_mode == "new") :
																																	?>
                                    <form class="form-horizontal"
								action="<?php echo "post/post_new_staff.php"; ?>" method="post"
								id="new_employee">
								<fieldset>
									<table class="table table-striped">
										...
										<tr>
											...
											<td>
                                                        ...
                                                        <input
												type="hidden" name="sanctioned_post"
												value="<?php echo $sanctioned_post_id; ?>" />
											</td>
										</tr>
										<tr>
											<td width="50%"><strong>Staff ID</strong></td>
											<td><?php echo $data['staff_id']; ?> <em class="text-success">(Will
													be added automatically)</em></td>
										</tr>
										<tr>
											<td width="50%"><strong>Staff Name</strong></td>
											<td><input type="text" id="staff_name" name="staff_name"
												placeholder="" required></td>
										</tr>
										<tr>
											<td width="50%"><strong>Code No.(Doctors Only):</strong></td>
											<td><input type="text" id="staff_pds_code"
												name="staff_pds_code" placeholder=""></td>
										</tr>
										<tr>
											<td width="50%"><strong>Department:</strong></td>
											<td>
                                                        <?php
                                                                                ...
                                                                                very_old_departments order by name asc";
																																	...
																																	?>                                   <select
												id="staff_department_id" name="staff_department_id">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['department_id']; ?>"><?php echo $data['name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											</td>
										</tr>
										<tr>
											...
											<td><input type="text" id="birth_date" name="birth_date"
												placeholder="yyyy-mm-dd" class='date-data'></td>
										</tr>
											...
											<td>
                                                        <?php
                                                                    ...
                                                                    staff_sex order by sex_name";
																																	...
																																	?>
                                                        <select
												id="staff_sex" name="staff_sex">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['sex_type_id']; ?>"><?php echo $data['sex_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											</td>
										</tr>
											...
											<td>
                                                        <?php
                                                                    ...
                                                                    staff_religious_group order by religious_group_name";
																																	...
																																	?>
                                                        <select
												id="staff_religion" name="staff_religion">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['religious_group_id']; ?>"><?php echo $data['religious_group_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											</td>
										</tr>
											...
											<td>
                                                        <?php
                                                                ...
                                                                staff_marital_status";
																																	...
																																	?>
                                                        <select
												id="staff_marital_status" name="staff_marital_status">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['marital_status_id']; ?>"><?php echo $data['marital_status']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
										...
										<tr>
											...
											<td><input type="text" id="mother_name" name="mother_name"
												placeholder=""></td>
										</tr>
										<!--
                                                   <tr>
										...
										<tr>
											...
											<td><input type="text" id="contact_no" name="contact_no"
												placeholder="" required,number></td>
										</tr>

										<tr>
											<td width="50%"><strong>Email</strong></td>
											<td><input type="text" id="email_address1"
												name="email_address1" placeholder="" required,email></td>
										</tr>

										<tr>
											<td width="50%"><strong>Present Address</strong></td>
											<td><textarea type="text" id="present_address"
													name="present_address" placeholder=""></textarea></td>
										</tr>
										<tr>
											<td width="50%"><strong>Permanent Address</strong></td>
											<td><textarea type="text" id="permanent_address"
													name="permanent_address" placeholder=""></textarea></td>
										</tr>
										<tr>
											<td width="50%"><strong>Freedom Fighter? </strong></td>
											<td>
                                                        <?php
                                                            ...
                                                            staff_freedom_fighter";
																																	...
																																	?>
                                                        <select
												id="staff_freedom_fighter" name="staff_freedom_fighter">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data2 = mysql_fetch_assoc($result2)): ?>
                                                                <option
														value="<?php echo $data2['id']; ?>"><?php echo $data2['freedom_fighter_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											...
											<td>
                                                        <?php
                                                           ...
                                                           staff_tribal";
																																	...
																																	?>
                                                        <select
												id="staff_tribal_id" name="staff_tribal_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['id']; ?>"><?php echo $data['tribal_value']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											</td>
										</tr>
											...
											<td>
                                                        <?php
                                                                ...
                                                                staff_job_class ";
																																	...
																																	?>
                                                        <select
												id="staff_job_class_value" name="staff_job_class_value">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['job_class_id']; ?>"><?php echo $data['job_class_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											</td>
										</tr>
											...
											<td width="50%"><strong>Category</strong></td>
													...
													FROM
													  staff_professional_category_type order by professional_type_id";
																																	...
																																	?>
                                                    <td><select
												id="staff_professional_categories"
												name="staff_professional_categories">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['professional_type_id']; ?>"><?php echo $data['professional_type_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
										<tr>
											...
											<td> <?php
                                                    ...
                                                    staff_post_type ";
                                                        ...
                                                        <select
												id="staff_post_type_id" name="staff_post_type_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['post_type_id']; ?>"><?php echo $data['post_type_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
										...
										<tr>
											...
											<td>
                                                   ...
                                                   ";
																																	...
																																	?>    <select
												id="staff_posting_type_id" name="staff_posting_type_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['staff_posting_type_id']; ?>"><?php echo $data['staff_posting_type_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											</td>
										</tr>
            ...
            staff_salary_draw_type order by salary_draw_type_id asc ";
																																	...
																																	?>
                                                        <select
												id="staff_salary_draw_type_id"
												name="staff_salary_draw_type_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['salary_draw_type_id']; ?>"><?php echo $data['salary_draw_type_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
            ...
            FROM
             staff_designation_type order by designation_type_id asc";
																																	$result = mysql_query ( $sql ) or die ( mysql_error () . "<br /><br />Code:<b>getSexNameFromId:1</b><br /><br /><b>Query:</b><br />___<br />$sql<br />" );
																																	?>  <select
												id="staff_designation_type_id"
												name="staff_designation_type_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['designation_type_id']; ?>"><?php echo $data['designation_type']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
            ...
            staff_job_posting";
																																	...
																																	?>
                                                        <select
												id="staff_job_posting_id" name="staff_job_posting_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['job_posting_id']; ?>"><?php echo $data['job_posting_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
										<tr>
            ...
            staff_working_status order by working_status_id asc ";
																																	$result = mysql_query ( $sql ) or die ( mysql_error () . "<br /><br />Code:<b>getSexNameFromId:1</b><br /><br /><b>Query:</b><br />___<br />$sql<br />" );
																																	?> <select
												id="staff_working_status_id" name="staff_working_status_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['working_status_id']; ?>"><?php echo $data['working_status_name']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select>
											</td>
										</tr>
										<tr>
											...
											<td>  <?php
                                                   ...
                                                   ";
																																	$result = mysql_query ( $sql ) or die ( mysql_error () . "<br /><br />Code:<b>getSalaryDrawTypeNameFromID:1</b><br /><br /><b>Query:</b><br />___<br />$sql<br />" );
																																	?>    <select
												id="staff_draw_salary_id" name="staff_draw_salary_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['draw_salary_id']; ?>"><?php echo $data['draw_salaray_place']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
										...
										<tr>
											<td width="50%"><strong>Current Basic Pay (Tk.):</strong></td>
											<td><input type="text" id="current_basic_pay_tk"
												name="current_basic_pay_tk" placeholder="" number></td>
										</tr>

										<tr>
											<td width="50%"><strong>Date Of Joining to Govt. Health
													Service</strong></td>
											<td><input type="text" id="date_of_joining_to_govt_service"
												name="date_of_joining_to_govt_service"
												placeholder="yyyy-mm-dd" class='date-data'></td>
										</tr>
										<tr>
											<td width="50%"><strong>Date Of Joining to Current Place</strong></td>
											<td><input type="text" id="date_of_joining_to_current_place"
												name="date_of_joining_to_current_place"
												placeholder="yyyy-mm-dd" class='date-data'></td>
										</tr>
										<tr>
											<td width="50%"><strong>Date Of Joining to Current
													Designation</strong></td>
											<td><input type="text"
												id="date_of_joining_to_current_designation"
												name="date_of_joining_to_current_designation"
												placeholder="yyyy-mm-dd" class='date-data'></td>
										...
										<tr>
											...
											<td>  <?php
                                                                                ...
                                                                                very_old_departments order by name asc";
																																	...
																																	?> <select
												id="staff_professional_discipline"
												name="staff_professional_discipline">
													<option value="0">-- Select form the list --</option>
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['department_id']; ?>"><?php echo $data['name']; ?></option>
            ...
            FROM
                staff_educational_qualification";
																																	$result = mysql_query ( $sql ) or die ( mysql_error () . "<br /><br />Code:<b>getSalaryDrawTypeNameFromID:1</b><br /><br /><b>Query:</b><br />___<br />$sql<br />" );
																																	?>    <select
												id="staff_educational_qualifiaction_Id"
												name="staff_educational_qualifiaction_Id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['educational_qualifiaction_Id']; ?>"><?php echo $data['educational_qualification']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
										<tr>
											<td width="50%"><strong>Actual Degree</strong></td>
											<td><input type="text" id="actual_degree"
												name="actual_degree" placeholder=""></td>
										</tr>
										<tr>
											<td width="50%"><strong>Pay Scale of Current Designation</strong></td>
											<td>  <?php
            ...
            FROM
                staff_pay_scale order by pay_scale_id asc";
																																	$result = mysql_query ( $sql ) or die ( mysql_error () . "<br /><br />Code:<b>getTypeOfPostNameFromCode:1</b><br /><br /><b>Query:</b><br />___<br />$sql<br />" );
																																	?> <select
												id="staff_pay_scale_id" name="staff_pay_scale_id">

                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['pay_scale_id']; ?>"><?php echo $data['pay_scale']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
										...
										<tr>
											...
											<td> <?php
												...
												id="staff_govt_quarter" name="staff_govt_quarter">
                                                            ...
                                                            <?php while ($data = mysql_fetch_assoc($result)): ?>
                                                                <option
														value="<?php echo $data['govt_quater_id']; ?>"><?php echo $data['govt_quater']; ?></option>
                                                            <?php endwhile; ?>
                                                        </select></td>
										</tr>
										...
										<tr>
											<td width="50%"><strong>Further Remarks/Explanation:</strong></td>
											<!--reason -->
											<td><textarea type="text" id="reason" name="reason"
													placeholder=""></textarea></td>
										</tr>

										<input type="hidden" id="new_staff" name="new_staff"
											value="yes">
	...
	<script>
            ...
            $('#employee-profile a.staff_name').editable({
                type: 'text',
                pk: <?php echo $staff_id; ?>,
                url: 'post/post_employee.php',
                params: function(params) {
            ...
            $('#employee-profile a.contact_no').editable({
                type: 'text',
                pk: <?php echo $staff_id; ?>,
                url: 'post/post_employee.php',
                params: function(params) {
            ...
            $('#employee-profile #birth_date').editable({
            	type: 'date',
                pk: <?php echo $staff_id; ?>,
                url: 'post/post_employee.php',
                format: 'yyyy-mm-dd',
